<template>
  ...
  >
    ...
    <div class="flex items-start justify-between mb-3">
      ...
      <span :class="getStatusColor(tournament.status)" class="px-2 py-1 rounded-full text-xs font-medium whitespace-nowrap ml-2">
    ...
    <!-- Format Badge -->
    <div class="mb-4">
      <span class="inline-flex items-center gap-1 px-3 py-1 bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 rounded-full text-xs font-medium">
